Public Class frmtauriinfo
    ...
    Private Sub Btntauriinfo_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Btntauriinfo.Click
        ...
        If result = MsgBoxResult.Yes Then
            frmMain._Client.SendData(NetComm.Host.Convert2Ascii(Array.IndexOf(frmMain.Lookup, "tutorial").ToString("00") & "1"), "")
    ...
    Private Sub frmtauriinfo_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
